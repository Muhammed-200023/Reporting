      ...
      if (inputType === 'number') {
        return (
          <input
            ...
            key={key}
            value={value}  
            className="font-semibold text-center mx-1 w-[75px] text-[#1F405A] border-b-[1px] border-dashed border-[#1F405A] mb-[2px]"
        ...
        return (
          <select
            key={key}
            value={value}  
            className="text-center w-[150px] h-[28px] text-[#1F405A] border-b-[1px] border-dashed border-[#1F405A] mb-[2px]"
            onChange={(e) => handleInputChange(pillarName, questionId, inputId, e.target.value)}
          >
